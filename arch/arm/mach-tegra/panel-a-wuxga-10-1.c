...
static struct tegra_dc_cmu dsi_a_wuxga_10_1_cmu = {
	...
	/* csc */
	{
		//use normal_matrix blending=1.0
		0x107, 0x3DC, 0x01C,
		0x3F1, 0x146, 0x3C7,
		0x3F9, 0x007, 0x0FE,
	},
	/* lut2 maps linear space to sRGB */
	{
		...
		168,  168,  169,  169,  169,  170,  170,  171,
		171,  171,  172,  172,  172,  173,  173,  173,
		174,  174,  175,  175,  175,  176,  176,  176,
		177,  177,  177,  178,  178,  179,  179,  179,
		...
		200,  200,  200,  200,  201,  201,  201,  202,
		202,  202,  202,  203,  203,  203,  203,  204,
		...
		225,  225,  225,  226,  226,  226,  226,  227,
		...
		238,  238,  239,  239,  239,  239,  240,  240,
		240,  240,  241,  241,  241,  241,  241,  242,
