...
static struct rmi_device_sensor_vendor sensor_vendor_id_table[] = {
	{
		.vendor_id = 0,
		.vendor_name = "hh",
	},
...
static struct rmi_device_platform_data synaptics_maya_platformdata = {
	...
	.multi_sensor_vendor_count = ARRAY_SIZE(sensor_vendor_id_table),
	.sensor_vendor_id = sensor_vendor_id_table,
#endif
};
